...
const projects = [
  {
    ...
    description:
      "A high-performance, responsive portfolio engineered with Next.js 16 (Turbopack), TypeScript, and Tailwind CSS. Fully type-safe and optimized for instant static delivery via Vercel.",
  ...
  },
  {
    title: "CropVector",
    description:
      "Agritech platform for farmers, buyers, experts and admins — unified crop & marketplace management.",
  ...
  },
  {
    title: "RemoteTeamPro",
    description:
      "Self-hosted PHP/MySQL team management for small teams — tasks, attendance, messaging, and client access.",
  ...
  },
  {
    title: "Next Release",
    description:
      "Currently in private beta. Coming soon on GitHub.",
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative py-36 border-t border-white/10">
          ...
          <div className="relative flex items-center gap-4">
            ...
            {projects.map((project) => (
              <article
                ...
                className="group relative z-10 min-w-[24rem] h-80 shrink-0 overflow-hidden rounded-4xl border border-white/10 bg-slate-950/40 shadow-2xl backdrop-blur-3xl transition-all duration-300 hover:z-9999 hover:shadow-2xl hover:border-white/20 animate-fade-in"
              >
